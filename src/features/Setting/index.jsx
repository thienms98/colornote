...
import { setView } from "../../app/reducers/settings";
...
function Settings({ setDf_nav, setColorNote, setUser }) {
  ...
  const CustomView = () => (
    <FormControl className='stand-select' variant='standard' sx={{ m: 1, minWidth: 80 }}>
      <Select id='view-select' value={view} onChange={handleViewChange} autoWidth>
      ...
      >
        <Grid item xs={24} sm={12} md={6} lg={6}>
          ...
          <Box sx={{ mt: 3, mb: 3 }}>
            ...
            />
            <BoxDoubleContent
              content_1={<span style={{ fontWeight: 600 }}>View Style:</span>}
              content_2={<CustomView />}
              customHeight='40px'
            />
          </Box>
          <Divider variant='middle' sx={{ maxWidth: "500px", minWidth: "300px" }} />
